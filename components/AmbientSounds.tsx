...
import { XIcon, MusicIcon } from './Icons.tsx';
...
const AmbientSounds: React.FC<AmbientSoundsProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-40 flex items-center justify-center" onClick={onClose}>
      <div className="bg-[#060644] border-2 border-[#69adaf] rounded-xl shadow-2xl p-6 w-full max-w-xs text-white" onClick={e => e.stopPropagation()}>
