...
const CarryOverBanner: React.FC<CarryOverBannerProps> = ({ message, onCarryOver, onDismiss }) => {
  return (
    <div className="mt-6 animate-fade-in">
      <div className="flex items-center bg-[#007370]/20 border border-[#007370]/50 rounded-xl overflow-hidden shadow-lg">
        <button
          onClick={onCarryOver}
        ...
        <div className="h-full border-l border-[#007370]/30 self-stretch flex items-center">
             <button 
                onClick={(e) => { e.stopPropagation(); onDismiss(); }}
                className="h-full px-4 text-[#69adaf] hover:text-[#ee6650] hover:bg-[#ee6650]/10 transition-colors flex items-center justify-center"
