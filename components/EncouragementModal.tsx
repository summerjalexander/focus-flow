...
const EncouragementModal: React.FC<EncouragementModalProps> = ({ message, isLoading, onClose }) => {
  return (
    ...
    >
      <div 
        className="bg-[#060644] rounded-2xl shadow-2xl shadow-[#ee6650]/20 p-8 max-w-md w-full text-center border border-[#69adaf] transform transition-all duration-300 scale-95"
