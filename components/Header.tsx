...
import { ChevronLeftIcon, ChevronRightIcon, FireIcon, CalendarDaysIcon } from './Icons.tsx';
  ...
  return (
    <header className="text-center text-[#f7f7f7] mb-8">
        <div className="flex justify-center items-center gap-4">
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#007370] to-[#ee6650]">
                Focus Flow
            </h1>
            {streak > 0 && (
      ...
      <p className="text-lg text-[#69adaf] mt-2">Your Daily ADHD Priority Checklist</p>
      <div className="flex items-center justify-center mt-6 space-x-4">
        ...
        <div className="text-center">
            <button 
              ...
              className="flex items-center gap-2 text-xl md:text-2xl font-bold tracking-wide hover:text-[#ee6650] transition-colors"
            >
