...
import { Task, TasksByDate, BrainDumpTask, Subtask, StreakData } from './types.ts';
import { MAX_TASKS } from './constants.ts';
import { getEncouragement, generateSubtasks } from './services/geminiService.ts';
import Header from './components/Header.tsx';
import TaskList from './components/TaskList.tsx';
import AddTaskForm from './components/AddTaskForm.tsx';
import EncouragementModal from './components/EncouragementModal.tsx';
import ProgressBar from './components/ProgressBar.tsx';
import { RefreshCwIcon, ShareIcon } from './components/Icons.tsx';
...
import AmbientSounds from './components/AmbientSounds.tsx';
import ProgressCalendar from './components/ProgressCalendar.tsx';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#060644] text-[#f7f7f7] p-4 sm:p-6 md:p-8 flex flex-col items-center">
      ...
      <div className="w-full max-w-2xl z-10">
        ...
        <main className="bg-[#060644]/50 backdrop-blur-sm border border-[#69adaf]/50 rounded-xl p-6 shadow-2xl shadow-black/20">
