...
const DatePicker: React.FC<DatePickerProps> = ({ isOpen, onClose, selectedDate, onSelectDate, tasksByDate }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-[#060644] rounded-2xl shadow-2xl p-4 sm:p-6 max-w-sm w-full border border-[#69adaf]"
            ...
            return (
              <div key={day} className="relative flex items-center justify-center">
                <button
                  ...
                  className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center transition-colors duration-200
